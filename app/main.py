...
with st.sidebar:
    ...
    with st.popover("📖 Инструкция пользователя", use_container_width=True):
        st.markdown("""
**IP Watch KZ — Краткая инструкция**

**1. Создание профиля мониторинга**
Перейдите в «Профили мониторинга» → вкладка «Создать профиль».
Укажите название, основное обозначение ТЗ и варианты написания
(кириллица, транслитерация, сочетания).

**2. Запуск проверки**
На Главной нажмите **«🔄 Проверить сейчас»** — система проверит
реестр и бюллетень Kazpatent по всем активным профилям.
Или перейдите в «Запуск проверки» для ручной настройки.

**3. Просмотр результатов**
Раздел «Результаты» — все найденные совпадения с фильтрами
по риску, источнику и статусу правовой оценки.

**4. Правовая оценка**
В результатах нажмите на запись → укажите уровень риска,
статус и рекомендуемое действие.

**5. Отчёт**
Раздел «Отчёты» → сформируйте Excel-отчёт по выбранному
периоду и профилям.
