...
5. Сформировать отчёт
    ...
    st.markdown(
        "<div style='border-top:1px solid rgba(255,255,255,0.08);margin-top:8px;padding-top:10px;'></div>",
        unsafe_allow_html=True,
    )
    if _current_user:
        ...
        st.markdown(f"""
        <div style='display:flex;align-items:center;gap:10px;padding:2px 6px 8px;'>
            <div style='width:34px;height:34px;border-radius:50%;background:#2563EB;color:#fff;
        ...
        """, unsafe_allow_html=True)
        with st.popover("Меню пользователя ⌄", use_container_width=True):
